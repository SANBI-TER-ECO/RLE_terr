...
alt_sum <- read.csv("https://raw.githubusercontent.com/SANBI-TER-ECO/LCC_terr_RLE/outputs/alt_sum.csv")
step_sum <- read.csv("https://raw.githubusercontent.com/SANBI-TER-ECO/LCC_terr_RLE/outputs/step_sum.csv")
lk_sum <- read.csv("https://raw.githubusercontent.com/SANBI-TER-ECO/LCC_terr_RLE/outputs/lk_sum.csv")
coct_sum <- read.csv("https://raw.githubusercontent.com/SANBI-TER-ECO/LCC_terr_RLE/outputs/coct_sum.csv")
nmb_sum <- read.csv("https://raw.githubusercontent.com/SANBI-TER-ECO/LCC_terr_RLE/outputs/nmb_sum.csv")
 
# data from land cover chnage stats from NLC 7 class
results_A2b_B_ROD <- read.csv("https://raw.githubusercontent.com/SANBI-TER-ECO/LCC_terr_RLE/outputs/results_A2b_B_ROD.csv")
results_A3nat <- read.csv("https://raw.githubusercontent.com/SANBI-TER-ECO/LCC_terr_RLE/outputs/results_A3.csv")

# data from meta nalysis of species threats per ecosystem type
results_B_TH_SP <- read.csv("https://raw.githubusercontent.com/SANBI-TER-ECO/LCC_terr_RLE/outputs/results_B_TH_SP.csv")

# data from invasive layers (created in Invasive_percentagres_all.qmd)
inv_comb <- read.csv("https://raw.githubusercontent.com/SANBI-TER-ECO/INV_terr_RLE/outputs/data_for_rle_inv_comb.csv")

# summed max stacked raster  invasive coverage - over estimate of IAP cover
#inv_max <- read.csv("https://raw.githubusercontent.com/SANBI-TER-ECO/INV_terr_RLE/outputs/data_for_rle_inv_max2.csv")
