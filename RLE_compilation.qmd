...
alt_sum <- read.csv("https://raw.githubusercontent.com/SANBI-TER-ECO/LCC_terr_RLE/main/outputs/alt_sum.csv")
step_sum <- read.csv("https://raw.githubusercontent.com/SANBI-TER-ECO/LCC_terr_RLE/main/outputs/step_sum.csv")
lk_sum <- read.csv("https://raw.githubusercontent.com/SANBI-TER-ECO/LCC_terr_RLE/main/outputs/lk_sum.csv")
coct_sum <- read.csv("https://raw.githubusercontent.com/SANBI-TER-ECO/LCC_terr_RLE/main/outputs/coct_sum.csv")
nmb_sum <- read.csv("https://raw.githubusercontent.com/SANBI-TER-ECO/LCC_terr_RLE/main/outputs/nmb_sum.csv")
 
# data from land cover change stats from NLC 7 class
results_A2b_B_ROD <- read.csv("outputs/results_A2b_B_ROD.csv")
results_A3nat <- read.csv("outputs/results_A3.csv")

# data from meta nalysis of species threats per ecosystem type
results_B_TH_SP <- read.csv("outputs/results_B_TH_SP.csv")

# data from invasive layers (created in Invasive_percentagres_all.qmd)
inv_comb <- read.csv("https://raw.githubusercontent.com/SANBI-TER-ECO/INV_terr_RLE/main/outputs/data_for_rle_inv_comb.csv")

# note that two additionalcondition datasets were analysed but they showed very low leves of degradation and triggered no threatened ecosystems for any criteria - they  were ommitted from this compilation; 
# Hardeveld degradation study (Bell et al. 2021) 
hv_sum <- read.csv("https://raw.githubusercontent.com/SANBI-TER-ECO/LCC_terr_RLE/main/outputs/hv_sum.csv")
# Little Karoo degradation study (Kirsten et al. 2023) 
lkk_sum <- read.csv("https://raw.githubusercontent.com/SANBI-TER-ECO/LCC_terr_RLE/main/outputs/lkk_sum.csv")
```
